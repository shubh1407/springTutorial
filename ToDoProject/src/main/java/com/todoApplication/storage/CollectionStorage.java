...
public class CollectionStorage {
	...
	public ToDoInfo getToDo(int id) {
		List<ToDoInfo> todoInfos = jdbcTemplate.query("select * from todo_info where id=?",new Object [] {id},new RowMapper<ToDoInfo>() {	
			@Override
			public ToDoInfo mapRow(ResultSet arg0, int arg1) throws SQLException {
				// TODO Auto-generated method stub
				return new ToDoInfo(arg0.getInt(1),arg0.getString(2),arg0.getDate(3),arg0.getBoolean(4));
	...
	public void deleteToDo(int id) {
		...
		jdbcTemplate.update("delete from todo_info where `id`=?",
				new Object[] {id});
	}
